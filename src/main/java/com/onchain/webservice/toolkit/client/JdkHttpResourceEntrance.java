package  com.onchain.webservice.toolkit.client;
 ...
 *
 */
public class JdkHttpResourceEntrance {
     ...
     */
    private static String post(String url, String params, boolean https) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException {
    	// 创建链接
    	URL u = new URL(url);
...
//        http.setRequestProperty("Content-Type","application/x-www-form-urlencoded");
    ...
    public static String post(String url, String params) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException {
    	System.out.println("cli_url:"+url);
    	System.out.println("cli_params:"+params);
    ...
    public static String postJson(String url, Map<String, String> params) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException {
    ...
    public static String get(String url, String params) throws KeyManagementException, NoSuchAlgorithmException, NoSuchProviderException, IOException {
